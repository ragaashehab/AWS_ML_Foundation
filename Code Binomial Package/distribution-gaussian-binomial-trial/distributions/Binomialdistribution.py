...
from .Generaldistribution import Distribution  # from .Generaldistribution import Distribution
...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        '''print("n replace {}".format(self.n)) debug message
        pos_trails = 0
        for e in self.data:
            if e > 0:
                pos_trails+=1
            #print("pos trails replace {}".format(pos_trails))
        pos_trails = self.data[self.data>0]
        self.p= pos_trails/self.n
        '''
    ...
    def pdf(self, k):
        ...
        #pass
        pdf_coffient = math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n -k))
        return pdf_coffient *(self.p**k) *(1-self.p)**(self.n-k)
    ...
    def __add__(self, other):
        ...
        #pass
        res_binomial= Binomial()
        res_binomial.n= self.n + other.n
        res_binomial.p = self.p
        return res_binomial
    ...
    def __repr__(self):
        ...
        #pass
        return "Mean : {} , Stdev : {} , p:{} , n: {}".format(self.calculate_mean(),
                                                                    self.calculate_stdev(), self.p , self.n )
